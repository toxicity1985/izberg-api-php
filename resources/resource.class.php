...
abstract class Resource
{
	...
	**/
	 ...
	 *
	**/
	public function get($id = null, $name = null, $params = null, $accept_type = "Accept: application/json")
	{
		if (!$id)
	 ...
	 *
	**/
	public function get_list($name = null, $params = null,$name = null, $accept_type = "Accept: application/json")
	{
		if (!$name)
			$name = $this->getName();

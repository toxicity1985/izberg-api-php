...
class CartTest extends BaseTester
{
  ...
  {
    VCR::insertCassette('testgetCartShouldReturnACart');
  ...
  {
    VCR::insertCassette('testgetCartItemsShouldReturnCartItems');
  ...
  {
    VCR::insertCassette('testinDebugModeCartShouldReturnDebugEqualToTrue');
  ...
  {
    VCR::insertCassette('testAddCartItemShouldAddItem');
    ...
    VCR::insertCassette('testAddCartItemShouldAddItem2');
    $cart = $a->get('Cart');
    $items = $cart->getItems();
    ...
    VCR::insertCassette('testAddCartItemShouldAddItem3');
    $items = $cart->getItems();
  ...
  {
    VCR::insertCassette('testCleanCartShouldRemoveAllItems');
    ...
    VCR::eject();
    VCR::insertCassette('testCleanCartShouldRemoveAllItems2');
    $items = $my_cart->getItems();
    $this->assertEquals(count($items), 1);
    $my_cart->clean();
    VCR::eject();
    VCR::insertCassette('testCleanCartShouldRemoveAllItems3');
    $items = $my_cart->getItems();
  ...
  {
    VCR::insertCassette('testNewCartItemShouldCreateANewCart1');
    $a = $this->getIzberg();
    $cart = $a->create('cart');
    VCR::eject();

    VCR::insertCassette('testNewCartItemShouldCreateANewCart2');
    $cart1 = $a->create('cart');
  ...
  public function testShippingWorkflow()
  {
    ...
    VCR::insertCassette('testShippingWorkflow1');
    ...
    VCR::eject();
    VCR::insertCassette('testShippingWorkflow2');
    ...
    VCR::eject();
    VCR::insertCassette('testShippingWorkflow3');
    $shipping_options = $cart->shippingOptions();
